...
Interpreter.prototype.stepConditionalExpression = function () {
    var a = this.stateStack[0];
    a.done ? (this.stateStack.shift(), "ConditionalExpression" == a.node.type && (this.stateStack[0].value = a.value)) : a.test ? (a.done = !0, (a.value==true) && a.node.consequent ? this.stateStack.unshift({
                                                                                                                                                                                                                   node: a.node.consequent
                                                                                                                                                                                                                   }) : !(a.value == true) && a.node.alternate && this.stateStack.unshift({
...
Interpreter.prototype.callback = function(d){};
